...
`computing_resources`` ``<-`` `[`tt_controller_elastic_slurm`](https://stemangiola.github.io/tidytargets/reference/tt_controller_elastic_slurm.md)`(`` `` workers ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``64``, ``48``, ``32``, ``24``, ``16``, ``8``)``,`` `` mem_gb_per_job ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``5``, ``10``, ``20``, ``40``, ``80``, ``160``)``,`` `` time_hours ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``4``, ``4``, ``4``, ``4``, ``4``, ``24``)``,`` `` crashes_max ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``6``, ``1``, ``1``, ``1``, ``1``, ``2``)`` ``)`
...
`computing_resources`` ``<-`` `[`tt_controller_elastic_slurm`](https://stemangiola.github.io/tidytargets/reference/tt_controller_elastic_slurm.md)`(`` `` workers ``=`` ``8``,`` `` mem_gb_per_job ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``5``, ``10``, ``20``, ``50``, ``100``)`` ``)`
