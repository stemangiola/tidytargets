...
| [`tt_import()`](https://stemangiola.github.io/tidytargets/reference/tt_import.md) | Snapshot a session object onto the store as one target |
| [`tt_import_list()`](https://stemangiola.github.io/tidytargets/reference/tt_import_list.md) | Snapshot a list onto the store as mapped units |
